...
/// </summary>
public partial struct ValueList4<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList4(scoped Span<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList4(scoped ReadOnlySpan<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList4(ReadOnlyMemory<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
    ...
    /// </summary>
    public static Span<T> AsSpan(ref ValueList4<T> valueList) {
