...
/// </summary>
public partial struct ValueList2<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(scoped Span<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(scoped ReadOnlySpan<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(ReadOnlyMemory<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(IEnumerable<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(scoped ValueList<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList2(scoped ValueHashSet<T> initialElements) {
        AddRange(initialElements.AsSpan());
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<T> AsSpan(ref ValueList2<T> valueList) {
    ...
    public struct Enumerator : IEnumerator<T> {
        private readonly ValueList2<T> List;
        private int Index;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Enumerator(ValueList2<T> list) {
            List = list;
            Index = -1;
        }
