...
partial struct ValueList128<T> {
    /// <summary>
    /// Returns every element matching <paramref name="predicate"/>.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Where(Func<T, bool> predicate) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TResult> Select<TResult>(Func<T, TResult> selector) {
        ValueList128<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TResult> Select<TResult>(Func<T, int, TResult> selector) {
        ValueList128<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector) {
        ValueList128<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TResult> SelectMany<TResult>(Func<T, int, IEnumerable<TResult>> selector) {
        ValueList128<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Append(T value) {
        ValueList128<T> result = new(this);
        result.Add(value);
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Prepend(T value) {
        ValueList128<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Reverse() {
        ValueList128<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TFilter> OfType<TFilter>() {
        ValueList128<TFilter> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<TResult> Cast<TResult>() {
        ValueList128<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Except(T value) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Except(scoped ReadOnlySpan<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList128<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
...
#endif
    public readonly ValueList128<T> Except(ReadOnlyMemory<T> values) {
...
#endif
    public readonly ValueList128<T> Except(IEnumerable<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList128<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Order() {
        ValueList128<T> result = new(this);
        result.Sort();
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> Order<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList128<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderDescending() {
        ValueList128<T> result = new(this);
        result.Sort();
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderDescending<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList128<T> result = new(this);
        result.Sort(comparer);
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderBy<TKey>(Func<T, TKey> keySelector) {
        ValueList128<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderBy<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList128<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderByDescending<TKey>(Func<T, TKey> keySelector) {
        ValueList128<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, Comparer<TKey>>(keySelector, Comparer<TKey>.Default));
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList128<T> OrderByDescending<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList128<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, TComparer>(keySelector, comparer));
        result.AsSpan().Reverse();
        return result;
