...
#endif
    public static ValueList3<T> ToValueList3<T>(this ValueList<T> valueList) {
        return new ValueList3<T>(valueList);
    }
...
#endif
    public static ValueList3<T> ToValueList3<T>(this scoped ValueHashSet<T> valueHashSet) {
        return new ValueList3<T>(valueHashSet);
    }
...
#endif
    public static ValueList3<KeyValuePair<TKey, TValue>> ToValueList3<TKey, TValue>(this scoped ValueDictionary<TKey, TValue> valueDictionary) {
        ValueList3<KeyValuePair<TKey, TValue>> valueList = new();
