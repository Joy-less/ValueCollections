...
partial struct ValueList16<T> {
    /// <summary>
    /// Returns every element matching <paramref name="predicate"/>.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Where(Func<T, bool> predicate) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TResult> Select<TResult>(Func<T, TResult> selector) {
        ValueList16<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TResult> Select<TResult>(Func<T, int, TResult> selector) {
        ValueList16<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector) {
        ValueList16<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TResult> SelectMany<TResult>(Func<T, int, IEnumerable<TResult>> selector) {
        ValueList16<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Append(T value) {
        ValueList16<T> result = new(this);
        result.Add(value);
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Prepend(T value) {
        ValueList16<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Reverse() {
        ValueList16<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TFilter> OfType<TFilter>() {
        ValueList16<TFilter> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<TResult> Cast<TResult>() {
        ValueList16<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Except(T value) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Except(scoped ReadOnlySpan<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList16<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
...
#endif
    public readonly ValueList16<T> Except(ReadOnlyMemory<T> values) {
...
#endif
    public readonly ValueList16<T> Except(IEnumerable<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList16<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Order() {
        ValueList16<T> result = new(this);
        result.Sort();
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> Order<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList16<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderDescending() {
        ValueList16<T> result = new(this);
        result.Sort();
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderDescending<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList16<T> result = new(this);
        result.Sort(comparer);
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderBy<TKey>(Func<T, TKey> keySelector) {
        ValueList16<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderBy<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList16<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderByDescending<TKey>(Func<T, TKey> keySelector) {
        ValueList16<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, Comparer<TKey>>(keySelector, Comparer<TKey>.Default));
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList16<T> OrderByDescending<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList16<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, TComparer>(keySelector, comparer));
        result.AsSpan().Reverse();
        return result;
