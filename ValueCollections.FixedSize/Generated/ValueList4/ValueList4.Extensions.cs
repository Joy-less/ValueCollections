...
/// <summary>
/// Extension methods for <see cref="ValueList4{T}"/>.
/// </summary>
public static class ValueList4Extensions {
    /// <summary>
    /// Gets a span over the elements in the list.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<T> AsSpan<T>(this ref ValueList4<T> valueList) {
        return ValueList4<T>.AsSpan(ref valueList);
    }
...
#endif
    public static ValueList4<T> ToValueList4<T>(this IEnumerable<T> enumerable) {
        return new ValueList4<T>(enumerable);
    }
...
#endif
    public static ValueList4<T> ToValueList4<T>(this ReadOnlyMemory<T> memory) {
        return new ValueList4<T>(memory);
    }
...
#endif
    public static ValueList4<T> ToValueList4<T>(this ValueList4<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T[] ToArray<T>(this ValueList4<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static List<T> ToList<T>(this ValueList4<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HashSet<T> ToHashSet<T>(this ValueList4<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Dictionary<TKey, TValue> ToDictionary<TSource, TKey, TValue>(this ValueList4<TSource> valueList, Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector) where TKey : notnull {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Dictionary<TKey, TValue> ToDictionary<TSource, TKey, TValue>(this ValueList4<TSource> valueList, Func<TSource, KeyValuePair<TKey, TValue>> keyValuePairSelector) where TKey : notnull {
        Dictionary<TKey, TValue> dictionary = new(valueList.Count);
        foreach (TSource element in valueList) {
