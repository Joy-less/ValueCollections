...
partial struct ValueList512<T> {
    /// <summary>
    /// Returns every element matching <paramref name="predicate"/>.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Where(Func<T, bool> predicate) {
        ValueList512<T> result = new();
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TResult> Select<TResult>(Func<T, TResult> selector) {
        ValueList512<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TResult> Select<TResult>(Func<T, int, TResult> selector) {
        ValueList512<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector) {
        ValueList512<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TResult> SelectMany<TResult>(Func<T, int, IEnumerable<TResult>> selector) {
        ValueList512<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Append(T value) {
        ValueList512<T> result = new(this);
        result.Add(value);
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Prepend(T value) {
        ValueList512<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Reverse() {
        ValueList512<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TFilter> OfType<TFilter>() {
        ValueList512<TFilter> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<TResult> Cast<TResult>() {
        ValueList512<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Except(T value) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Except(scoped ReadOnlySpan<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList512<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
...
#endif
    public readonly ValueList512<T> Except(ReadOnlyMemory<T> values) {
...
#endif
    public readonly ValueList512<T> Except(IEnumerable<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList512<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Order() {
        ValueList512<T> result = new(this);
        result.Sort();
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> Order<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList512<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderDescending() {
        ValueList512<T> result = new(this);
        result.Sort();
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderDescending<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList512<T> result = new(this);
        result.Sort(comparer);
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderBy<TKey>(Func<T, TKey> keySelector) {
        ValueList512<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderBy<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList512<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderByDescending<TKey>(Func<T, TKey> keySelector) {
        ValueList512<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, Comparer<TKey>>(keySelector, Comparer<TKey>.Default));
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList512<T> OrderByDescending<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList512<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, TComparer>(keySelector, comparer));
        result.AsSpan().Reverse();
        return result;
