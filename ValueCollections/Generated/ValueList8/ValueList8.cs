...
/// </summary>
public partial struct ValueList8<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(scoped Span<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(scoped ReadOnlySpan<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(ReadOnlyMemory<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(IEnumerable<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(scoped ValueList<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList8(scoped ValueHashSet<T> initialElements) {
        AddRange(initialElements.AsSpan());
    }
    ...
    /// </summary>
    public static Span<T> AsSpan(ref ValueList8<T> valueList) {
    ...
    public struct Enumerator : IEnumerator<T> {
        private readonly ValueList8<T> List;
        private int Index;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Enumerator(ValueList8<T> list) {
            List = list;
            Index = -1;
        }
