...
/// </summary>
public partial struct ValueList64<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(scoped Span<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(scoped ReadOnlySpan<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(ReadOnlyMemory<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(IEnumerable<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(scoped ValueList<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList64(scoped ValueHashSet<T> initialElements) {
        AddRange(initialElements.AsSpan());
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<T> AsSpan(ref ValueList64<T> valueList) {
    ...
    public struct Enumerator : IEnumerator<T> {
        private readonly ValueList64<T> List;
        private int Index;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Enumerator(ValueList64<T> list) {
            List = list;
            Index = -1;
        }
