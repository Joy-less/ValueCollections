...
#endif
    public static ValueList32<T> ToValueList32<T>(this ValueList<T> valueList) {
        return new ValueList32<T>(valueList);
    }
...
#endif
    public static ValueList32<T> ToValueList32<T>(this scoped ValueHashSet<T> valueHashSet) {
        return new ValueList32<T>(valueHashSet);
    }
...
#endif
    public static ValueList32<KeyValuePair<TKey, TValue>> ToValueList32<TKey, TValue>(this scoped ValueDictionary<TKey, TValue> valueDictionary) {
        ValueList32<KeyValuePair<TKey, TValue>> valueList = new();
