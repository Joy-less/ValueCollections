...
public partial struct ValueList3<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<T> AsSpan(ref ValueList3<T> valueList) {
    ...
    /// <summary>
    /// Enumerates the elements of a <see cref="ValueList3{T}"/>.
    /// </summary>
    public struct Enumerator : IEnumerator<T> {
        private readonly ValueList3<T> List;
        private int Index;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Enumerator(ValueList3<T> list) {
            List = list;
            Index = -1;
        }
