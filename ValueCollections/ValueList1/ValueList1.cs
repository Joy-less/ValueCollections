...
/// </summary>
public partial struct ValueList1<T> : IList<T>, IReadOnlyList<T> {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(scoped Span<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(scoped ReadOnlySpan<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(ReadOnlyMemory<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(IEnumerable<T> initialElements) {
        AddRange(initialElements);
    }
    /// <summary>
    /// Constructs a value list with the given elements.
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(scoped ValueList<T> initialElements) {
...
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ValueList1(scoped ValueHashSet<T> initialElements) {
        AddRange(initialElements.AsSpan());
    }
    ...
    /// </summary>
    public static Span<T> AsSpan(ref ValueList1<T> valueList) {
    ...
    public struct Enumerator : IEnumerator<T> {
        private readonly ValueList1<T> List;
        private int Index;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal Enumerator(ValueList1<T> list) {
            List = list;
            Index = -1;
        }
