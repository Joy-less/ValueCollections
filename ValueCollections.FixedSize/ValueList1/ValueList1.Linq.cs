...
partial struct ValueList1<T> {
    /// <summary>
    /// Returns every element matching <paramref name="predicate"/>.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Where(Func<T, bool> predicate) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TResult> Select<TResult>(Func<T, TResult> selector) {
        ValueList1<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TResult> Select<TResult>(Func<T, int, TResult> selector) {
        ValueList1<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector) {
        ValueList1<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TResult> SelectMany<TResult>(Func<T, int, IEnumerable<TResult>> selector) {
        ValueList1<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Append(T value) {
        ValueList1<T> result = new(this);
        result.Add(value);
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Prepend(T value) {
        ValueList1<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Reverse() {
        ValueList1<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TFilter> OfType<TFilter>() {
        ValueList1<TFilter> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<TResult> Cast<TResult>() {
        ValueList1<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Except(T value) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Except(scoped ReadOnlySpan<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList1<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
...
#endif
    public readonly ValueList1<T> Except(ReadOnlyMemory<T> values) {
...
#endif
    public readonly ValueList1<T> Except(IEnumerable<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList1<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Order() {
        ValueList1<T> result = new(this);
        result.Sort();
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> Order<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList1<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderDescending() {
        ValueList1<T> result = new(this);
        result.Sort();
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderDescending<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList1<T> result = new(this);
        result.Sort(comparer);
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderBy<TKey>(Func<T, TKey> keySelector) {
        ValueList1<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderBy<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList1<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderByDescending<TKey>(Func<T, TKey> keySelector) {
        ValueList1<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, Comparer<TKey>>(keySelector, Comparer<TKey>.Default));
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList1<T> OrderByDescending<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList1<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, TComparer>(keySelector, comparer));
        result.AsSpan().Reverse();
        return result;
