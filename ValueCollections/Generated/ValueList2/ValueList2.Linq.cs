...
partial struct ValueList2<T> {
    /// <summary>
    /// Returns every element matching <paramref name="predicate"/>.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Where(Func<T, bool> predicate) {
        ValueList2<T> result = new();
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TResult> Select<TResult>(Func<T, TResult> selector) {
        ValueList2<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TResult> Select<TResult>(Func<T, int, TResult> selector) {
        ValueList2<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TResult> SelectMany<TResult>(Func<T, IEnumerable<TResult>> selector) {
        ValueList2<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TResult> SelectMany<TResult>(Func<T, int, IEnumerable<TResult>> selector) {
        ValueList2<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Append(T value) {
        ValueList2<T> result = new(this);
        result.Add(value);
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Prepend(T value) {
        ValueList2<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Reverse() {
        ValueList2<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TFilter> OfType<TFilter>() {
        ValueList2<TFilter> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<TResult> Cast<TResult>() {
        ValueList2<TResult> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Except(T value) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Except(scoped ReadOnlySpan<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList2<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
...
#endif
    public readonly ValueList2<T> Except(ReadOnlyMemory<T> values) {
...
#endif
    public readonly ValueList2<T> Except(IEnumerable<T> values) {
        EqualityComparer<T> comparer = EqualityComparer<T>.Default;
        ValueList2<T> result = new();
        for (int index = 0; index < Count; index++) {
            T element = Buffer[index];
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Order() {
        ValueList2<T> result = new(this);
        result.Sort();
        return result;
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> Order<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList2<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderDescending() {
        ValueList2<T> result = new(this);
        result.Sort();
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderDescending<TComparer>(TComparer comparer) where TComparer : IComparer<T> {
        ValueList2<T> result = new(this);
        result.Sort(comparer);
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderBy<TKey>(Func<T, TKey> keySelector) {
        ValueList2<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderBy<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList2<T> result = new(this);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderByDescending<TKey>(Func<T, TKey> keySelector) {
        ValueList2<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, Comparer<TKey>>(keySelector, Comparer<TKey>.Default));
        result.AsSpan().Reverse();
        return result;
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly ValueList2<T> OrderByDescending<TKey, TComparer>(Func<T, TKey> keySelector, TComparer comparer) where TComparer : IComparer<TKey> {
        ValueList2<T> result = new(this);
        result.Sort(new KeySelectorComparer<TKey, TComparer>(keySelector, comparer));
        result.AsSpan().Reverse();
        return result;
