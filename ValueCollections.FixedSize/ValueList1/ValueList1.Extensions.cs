...
#endif
    public static ValueList1<T> ToValueList1<T>(this ValueList<T> valueList) {
        return new ValueList1<T>(valueList);
    }
...
#endif
    public static ValueList1<T> ToValueList1<T>(this scoped ValueHashSet<T> valueHashSet) {
        return new ValueList1<T>(valueHashSet);
    }
...
#endif
    public static ValueList1<KeyValuePair<TKey, TValue>> ToValueList1<TKey, TValue>(this scoped ValueDictionary<TKey, TValue> valueDictionary) {
        ValueList1<KeyValuePair<TKey, TValue>> valueList = new();
