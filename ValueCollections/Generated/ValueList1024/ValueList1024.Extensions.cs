...
/// <summary>
/// Extension methods for <see cref="ValueList1024{T}"/>.
/// </summary>
public static class ValueList1024Extensions {
    /// <summary>
    /// Gets a span over the elements in the list.
    /// </summary>
    public static Span<T> AsSpan<T>(this ref ValueList1024<T> valueList) {
    ...
    public static ValueList1024<T> ToValueList1024<T>(this IEnumerable<T> enumerable) {
        return new ValueList1024<T>(enumerable);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024<T>(this scoped ReadOnlySpan<T> span) {
        return new ValueList1024<T>(span);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024<T>(this ValueList1024<T> valueList) {
        return new ValueList1024<T>(valueList);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024<T>(this ValueList<T> valueList) {
        return new ValueList1024<T>(valueList);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024<T>(this scoped ValueHashSet<T> valueHashSet) {
        return new ValueList1024<T>(valueHashSet);
    }
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<KeyValuePair<TKey, TValue>> ToValueList1024<TKey, TValue>(this scoped ValueDictionary<TKey, TValue> valueDictionary) {
        ValueList1024<KeyValuePair<TKey, TValue>> valueList = new();
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024Where<T>(this IEnumerable<T> enumerable, Func<T, bool> predicate) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueList1024<T> ToValueList1024OfType<T>(this IEnumerable enumerable) {
        ValueList1024<T> result = new();
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static T[] ToArray<T>(this ValueList1024<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static List<T> ToList<T>(this ValueList1024<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HashSet<T> ToHashSet<T>(this ValueList1024<T> valueList) {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Dictionary<TKey, TValue> ToDictionary<TSource, TKey, TValue>(this ValueList1024<TSource> valueList, Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector) where TKey : notnull {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Dictionary<TKey, TValue> ToDictionary<TSource, TKey, TValue>(this ValueList1024<TSource> valueList, Func<TSource, KeyValuePair<TKey, TValue>> keyValuePairSelector) where TKey : notnull {
        Dictionary<TKey, TValue> dictionary = new(valueList.Count);
        foreach (TSource element in valueList) {
